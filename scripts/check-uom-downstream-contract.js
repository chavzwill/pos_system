...
const checks=[
 ...
 ['purchase receipt UOM guard is mounted before receipt posting',receiptCore.indexOf("router.use(require('./purchase-receipt-uom-guard'))")>=0&&receiptCore.indexOf("purchase-receipt-uom-guard")<receiptCore.indexOf("router.patch('/:id/receive'")],
 ...
 ['receipt conversion remains ahead of serial lot identity validation',receiptCore.indexOf('purchase-receipt-uom-guard')<receiptCore.indexOf('validateReceiptIdentity')],
