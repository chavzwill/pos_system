...
const DEFINITIONS=Object.freeze({
 ...
 APPROVAL_HANDLER_UNAVAILABLE:{status:409,message:'This request cannot be approved here yet. Open the original request and follow its available review steps.'},
 ...
 PURCHASE_REQUEST_APPROVAL_REQUIRED:{status:409,message:'This purchase request must be approved or rejected through Department Approvals.'},
 PURCHASE_REQUEST_DEPARTMENT_REQUIRED:{status:400,message:'Choose an active approval department before submitting this purchase request.'},
 PURCHASE_REQUEST_NOT_FOUND:{status:404,message:'This purchase request could not be found.'},
 PURCHASE_REQUEST_BRANCH_FORBIDDEN:{status:403,message:'This purchase request belongs to another branch. Use your assigned branch or an authorized cross-branch account.'},
 PURCHASE_REQUEST_NOT_DRAFT:{status:409,message:'Only a draft purchase request can be submitted for approval.'},
 PURCHASE_REQUEST_NOT_PENDING:{status:409,message:'This purchase request is no longer waiting for approval.'},
 PURCHASE_REQUEST_ALREADY_DECIDED:{status:409,message:'This purchase request has already completed its department approval.'},
 CREDIT_CHANGE_APPROVAL_REQUIRED:{status:409,message:'Customer credit changes must be requested and approved through Department Approvals.'},
 CREDIT_CHANGE_CUSTOMER_NOT_FOUND:{status:404,message:'This customer could not be found or is not active.'},
 CREDIT_CHANGE_DEPARTMENT_REQUIRED:{status:400,message:'Choose an active Accounts approval department before submitting this credit change.'},
 CREDIT_CHANGE_INVALID:{status:400,message:'Enter a valid credit limit and payment terms before submitting this request.'},
 CREDIT_CHANGE_ALREADY_PENDING:{status:409,message:'This customer already has a credit change waiting for review.'},
