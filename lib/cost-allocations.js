...
async function ensureCostAllocationSchema() {
  await db.batch([
    ...
    {sql:`CREATE TABLE IF NOT EXISTS cost_attention_cases(
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      target_type TEXT NOT NULL,
      target_id TEXT,
      target_label TEXT,
    ...
    {sql:'CREATE INDEX IF NOT EXISTS idx_cost_attention_status ON cost_attention_cases(status,priority,last_seen_at)'},
