...
const browserScripts = [
  'app-shell.js','sales-workspace.js','cashier-controls-workspace.js','customer-crm-workspace.js','admin-workspace.js','transfers-workspace.js','work-orders-workspace.js','inventory-workspace.js','purchasing-workspace.js','rentals-workspace.js','client-diagnostics.js','pos-guide-map.js','guided-mode.js','technician-compensation.js','stock-rebalancing.js','operational-reports.js','repair-operations.js','repair-communications.js','repair-notifications.js','repair-authorizations.js','repair-parts-integrity.js','inventory-intelligence.js','logistics-intelligence.js','scheduling-intelligence.js','accounting-intelligence.js','financial-controls-intelligence.js','supplier-ledger.js','settlement-reconciliation.js','accounting-ledger.js','pos-upgrade-navigation.js','navigation-shell.js','role-workspace.js','employee-workspace-home.js','login-controller.js',
];
