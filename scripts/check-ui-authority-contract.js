...
check('workspace UI authority is the final stylesheet',shell.lastIndexOf('/total-tools-workspace-ui.css')>shell.lastIndexOf('/total-tools-ui-system.css')&&shell.indexOf('rel="stylesheet"',shell.lastIndexOf('/total-tools-workspace-ui.css'))<0);
