...
const lib=read('lib/purchase-receiving-controls.js'),receive=read('routes/purchase-receipt-traceability.js'),control=read('routes/purchase-receiving-controls.js');
const checks=[
