...
async function syncRetailReturns({actorId,stats}){
  ...
  for(const r of rows){
    try{
      ...
      // Replacement returns are deliberately quarantined rather than restored
      // to sellable inventory. Their accounting impact is the outgoing replacement
      // issue above; do not reverse original COGS for the defective returned unit.
