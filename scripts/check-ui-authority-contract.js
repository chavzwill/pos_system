...
check('targeted workspace refinement is loaded',shell.includes('/total-tools-workspace-refinement.css'));
check('targeted workspace refinement is the final stylesheet',shell.lastIndexOf('/total-tools-workspace-refinement.css')>shell.lastIndexOf('/total-tools-workspace-ui.css')&&shell.indexOf('rel="stylesheet"',shell.lastIndexOf('/total-tools-workspace-refinement.css'))<0);
...
check('refinement covers desktop/tablet/mobile breakpoints',refinementCss.includes('@media(max-width:1180px)')&&refinementCss.includes('@media(max-width:900px)')&&refinementCss.includes('@media(max-width:560px)'));
