...
const checks=[
 ...
 ['return dispatch requires release-stage processing and financial clearance',handoff.includes("['awaiting_pickup','picked_up']")&&handoff.includes('after customer notification and release-stage processing')&&handoff.includes('final repair balance is settled')&&handoff.includes('final_transaction_id')],
 ...
 ['repair UI only exposes return at release stages',repairUi.includes("['awaiting_pickup','picked_up']")&&repairUi.includes('Send return delivery')],
