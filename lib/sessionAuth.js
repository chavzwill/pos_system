...
const { employeePinCredentialGuard } = require('./credentialMutationGuard');
...
async function sessionAuth(req, res, next) {
  ...
  try {
    ...
    if (privilegedPasswordResetRequest(req)) {
    ...
    return employeePinCredentialGuard(req, res, next);
  } catch (e) {
...
module.exports = {
  ...
  privilegedPasswordResetRequest,
