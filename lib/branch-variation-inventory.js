...
async function ensureCoreSchema(){
  ...
  schemaReady=(async()=>{
    await db.batch([
      ...
      // Replacement processing owns this table too. Defining the exact same
      // shape here means the branch-variation replacement guard exists before
      // the first replacement request on a fresh database, rather than only
      // after a later request happens to trigger a schema sweep.
