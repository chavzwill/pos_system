...
'/purchase-order-document-context.js',
'/held-sales-recall-context.js',
'/total-tools-identity.js',
'/shell-native-support.js',
'/operations-attention-center.js',
'/workspace-quality-pass.js',
'/service-concessions-ui.js',
'/service-refunds-ui.js',
'/rental-fleet-management.js',
'/rental-fleet-disposal.js',
'/rental-fleet-transfer.js',
'/logistics-commercial-handoff.js',
'/logistics-field-execution.js',
'/logistics-route-planning.js',
'/logistics-location-intelligence.js'
].forEach(add);};if('requestIdleCallback'in window)requestIdleCallback(run,{timeout:450});else setTimeout(run,60);}
