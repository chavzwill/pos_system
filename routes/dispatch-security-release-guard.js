...
// The command center reads field-execution evidence before the generic field
// router is reached, so initialize those durable dependencies first.
router.use(require('./role-operations-command-center-prereq'));
