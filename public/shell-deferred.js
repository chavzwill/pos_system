...
function schedule(){const run=()=>{
 // Order matters. The base guide owns UI/state; orchestration comes next; the
 // remaining layers may observe it but must never initialize ahead of it.
 ['/guided-mode.js','/guided-mode-orchestrator.js','/guided-mode-access.js','/guided-mode-completion.js','/guided-mode-role-context.js','/guided-mode-record-context.js','/guided-mode-exact-action.js','/guided-mode-hardening.js','/guided-mode-integrity.js','/guided-mode-adversarial.js','/guided-mode-qa.js','/total-tools-identity.js','/shell-native-support.js','/workspace-quality-pass.js'].forEach(add);
 };if('requestIdleCallback'in window)requestIdleCallback(run,{timeout:450});else setTimeout(run,60);}
