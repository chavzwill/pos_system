...
const workflows=[
 ...
 {name:'Cash drawer',route:'/api/drawers',routeFile:'routes/drawers.js',workspace:'drawer',global:'TotalToolsCashDrawerWorkspace',guide:null},
 ...
 {name:'Cycle count',route:'/api/warehouse',routeFile:'routes/warehouse.js',workspace:'warehouse',global:'TotalToolsWarehouseOperations',guide:'Run a stock or cycle count'},
 ...
 {name:'Quotation',route:'/api/quotations',routeFile:'routes/quotations.js',workspace:'quotations-workspace',global:'TotalToolsQuotationsWorkspace',guide:null},
 ...
 {name:'Technician compensation',route:'/api/technician-compensation',routeFile:'routes/technician-compensation.js',workspace:'technician-performance',global:'TotalToolsTechnicianCompensation',guide:'Review technician compensation'},
 {name:'Inventory intelligence',route:'/api/inventory-intelligence',routeFile:'routes/inventory-intelligence.js',workspace:'inventory-intelligence',global:'TotalToolsInventoryIntelligence',guide:null}
];
for(const w of workflows){
 ...
 if(w.guide)check(`${w.name}: Guided Mode task covered`,guide.includes(`title:'${w.guide}'`));
 if(w.workspace){check(`${w.name}: workspace registered`,loader.includes(`'${w.workspace}'`));check(`${w.name}: workspace global registered`,loader.includes(w.global));}
}
...
check('Held-sale recall context is registered as a hardened workspace extra',loader.includes("'held-sales-workspace':['/held-sales-recall-context.js']"));
