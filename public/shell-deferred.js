...
function schedule(){const run=()=>{['/guided-mode.js','/guided-mode-orchestrator.js','/guided-mode-access.js','/purchase-order-document-context.js','/guided-mode-completion.js','/guided-mode-role-context.js','/guided-mode-record-context.js','/guided-mode-exact-action.js','/guided-mode-exact-fallback.js','/guided-mode-hardening.js','/guided-mode-integrity.js','/guided-mode-adversarial.js','/guided-mode-qa.js','/total-tools-identity.js','/shell-native-support.js','/workspace-quality-pass.js'].forEach(add);};if('requestIdleCallback'in window)requestIdleCallback(run,{timeout:450});else setTimeout(run,60);}
