...
const loading=new Map(),loadedExtras=new Set();
function ensureCss(href){if([...document.styleSheets].some(x=>x.href&&new URL(x.href).pathname===href))return;const l=document.createElement('link');l.rel='stylesheet';l.href=`${href}?v=${VERSION}`;l.onerror=()=>console.warn('POS workspace stylesheet failed',href);document.head.appendChild(l);}
