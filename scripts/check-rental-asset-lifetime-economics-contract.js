...
const route=read('routes/rental-asset-lifetime-economics.js'),trace=read('routes/inventory-traceability.js');
new vm.Script(route,{filename:'rental asset lifetime economics'});
const checks=[
 ...
 ['disposal requires financial or writeoff authority',route.includes("requireAnyPermission('reports_financial','inventory_writeoff_approve')")],
