...
if(route)new vm.Script(route,{filename:'employee-stock-finder.js'});if(ui)new vm.Script(ui,{filename:'stock-finder-ui.js'});
const checks=[
 ...
 ['UI offers existing workflow continuation',ui.includes('Sell item')&&ui.includes('Start transfer')&&ui.includes('Open Purchasing')&&ui.includes('View item')],
 ['Authenticated shell loads Stock Finder UI',deferred.includes("'/stock-finder-ui.js'")]
];
