...
const SCOPE_RULES = [
  ...
  // SmartCommerce/commerce clients receive catalog and availability only;
  // re-use the existing product-read authority rather than creating a broad
  // integration master scope.
  ...
  // employee work-order API: it exports only customer-visible service data.
