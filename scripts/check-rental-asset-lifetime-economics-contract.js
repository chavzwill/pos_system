...
const checks=[
 ...
 ['allocated internal consumption is evidenced separately from requested spend',route.includes('actual_consumed_cost')&&route.includes('requested_allocated_cost')&&route.includes("source_type='internal_consumption'")&&route.includes("source_type='purchase_request'")],
 ['incomplete consumption valuation is surfaced rather than invented',route.includes('incomplete_valuation_lines')&&route.includes("valuation_status!='fully_valued'")],
